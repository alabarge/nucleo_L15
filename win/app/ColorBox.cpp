...
BEGIN_MESSAGE_MAP(CColorBox, CListBox)
...
//-------------------------------------------------------------------
//
void CColorBox::DrawItem(LPDRAWITEMSTRUCT lpDIS)
//
// Return Value:	None.
//
...
//-------------------------------------------------------------------
//
void CColorBox::MeasureItem(LPMEASUREITEMSTRUCT lpMIS)
//
// Return Value:	None.
//
...
//-------------------------------------------------------------------
//
int CColorBox::AddString(LPCTSTR lpszItem)
//
...
//-------------------------------------------------------------------
//
int CColorBox::AddString(LPCTSTR lpszItem, COLORREF rgb)
//
// Return Value:	The zero-based index to the string in the list box.
//						The return value is LB_ERR if an error occurs; the
//						return value is LB_ERRSPACE if insufficient space
...
//-------------------------------------------------------------------
//
int CColorBox::InsertString(int nIndex, LPCTSTR lpszItem)
//
...
//-------------------------------------------------------------------
//
int CColorBox::InsertString(int nIndex, LPCTSTR lpszItem, COLORREF rgb)
//
// Return Value:	The zero-based index of the position at which the
//						string was inserted. The return value is LB_ERR if
//						an error occurs; the return value is LB_ERRSPACE if
...
//-------------------------------------------------------------------
//
void CColorBox::SetItemColor(int nIndex, COLORREF rgb)
//
// Return Value:	None.
//
