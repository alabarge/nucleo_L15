...
NoMangle int DLL_IMPORT_EXPORT    SioBaud(int,unsigned int);
NoMangle int DLL_IMPORT_EXPORT    SioBrkSig(int,char);
NoMangle int DLL_IMPORT_EXPORT    SioByteToShort(char *Ptr);
NoMangle USHORT DLL_IMPORT_EXPORT SioCRC16(BYTE *, int);
...
NoMangle int DLL_IMPORT_EXPORT    SioGets(int,char *,unsigned int);
NoMangle int DLL_IMPORT_EXPORT    SioGetsC(int, char *, int, unsigned int, char);
NoMangle int DLL_IMPORT_EXPORT    SioHexView(char *,int,char *,int);
NoMangle int DLL_IMPORT_EXPORT    SioInfo(char);
NoMangle int DLL_IMPORT_EXPORT    SioKeyCode(unsigned int);
...
NoMangle int DLL_IMPORT_EXPORT    SioPuts(int,char *,unsigned int);
NoMangle int DLL_IMPORT_EXPORT    SioQuiet(int, unsigned int, unsigned int);
...
NoMangle int DLL_IMPORT_EXPORT    SioRxWait(int, unsigned int, unsigned int);
...
NoMangle int DLL_IMPORT_EXPORT    SioStatus(int,unsigned int);
NoMangle DWORD DLL_IMPORT_EXPORT  SioTimeMark(DWORD);
...
NoMangle int DLL_IMPORT_EXPORT    SioWaitFor(int, unsigned int);
